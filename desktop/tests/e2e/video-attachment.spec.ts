...
// The fresh-profile default is the HireShelby theme, which pins the neutral accent
// regardless of the stored accent color. Accent-driven review foreground
// assertions must run on a non-HireShelby theme for the seeded accent to apply.
