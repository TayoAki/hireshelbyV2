//! Preservation of HireShelby snapshot tEXt chunks through the upload sanitizer.
//!
...
/// Extract the raw bytes of the first HireShelby snapshot tEXt chunk (length + type
