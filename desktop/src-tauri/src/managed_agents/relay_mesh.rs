...
/// Translate the native HireShelby shared compute provider into the OpenAI-compatible
...
pub fn apply_relay_mesh_env(
    ...
    // HireShelby owns the meaning of relay-mesh `auto`: buzz-agent dynamically uses
