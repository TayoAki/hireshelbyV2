...
fn resolve_effective_agent_env_with_def(
    ...
    // HireShelby shared compute is a native HireShelby provider. Translate it to buzz-agent's
...
/// require them from HireShelby's env layer.  The file layer only *silences*
...
mod tests {
    ...
    fn cli_login_requirements_codex_outdated_adapter_emits_adapter_outdated() {
        ...
        // intentionally prefers HireShelby's managed npm shim when it exists, which
