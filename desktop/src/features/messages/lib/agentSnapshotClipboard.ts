...
/** Build HireShelby-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a HireShelby snapshot clipboard payload into one pending attachment. */
