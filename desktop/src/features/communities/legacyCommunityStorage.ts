...
/**
 * Seed HireShelby localStorage from legacy Sprout WebKit localStorage before the app
 ...
 * HireShelby does not already have community state, except for the known broken
 * Sprout→HireShelby first-run handoff that created a single localhost community.
 */
