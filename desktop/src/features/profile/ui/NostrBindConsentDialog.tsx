...
const COPY_SUCCESS_MESSAGE =
  "Signed response copied. Paste it into the HireShelby admin console.";
const PREVIEW_COPY_SUCCESS_MESSAGE = "Preview response copied.";
const COPY_FAILURE_MESSAGE =
  "HireShelby couldn't access the clipboard. Try again.";
    ...
    const unlistenPromise = listenForNostrBindDeepLinks((nextPayload) => {
      ...
      getIdentity()
        ...
        .catch((error) => {
          ...
          setIdentity(null);
          setError("Could not load the current HireShelby identity.");
        });
    });
                ...
                >
                  <DialogPrimitive.Title className="mt-6 text-3xl font-semibold tracking-tight">
                    {payload.returnMode === "browser_fragment_v1"
                      ...
                      : "Finish on the HireShelby website"}
                  ...
                  >
                    {payload.returnMode === "browser_fragment_v1"
                      ? "HireShelby opened your browser to finish verification."
                      : "Copy the response below, then paste it into the HireShelby website to finish verification."}
                  </DialogPrimitive.Description>
