...
const STAGE_CHARACTERS: readonly StageCharacter[] = [
  { name: "Shelby", animationUrl: "/onboarding/starter-team/shelby.png" },
  { name: "Ada", animationUrl: "/onboarding/starter-team/ada.png" },
  { name: "Miles", animationUrl: "/onboarding/starter-team/miles.png" },
];
