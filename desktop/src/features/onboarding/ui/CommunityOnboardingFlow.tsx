...
const STARTER_PERSONA_ANIMATIONS: Record<string, string> = {
  Shelby: "/onboarding/starter-team/shelby.png",
  Ada: "/onboarding/starter-team/ada.png",
  Miles: "/onboarding/starter-team/miles.png",
};
          ...
          transaction.stage === "connecting" ? (
            ...
            <>
              ...
              <p className="mx-auto mt-3 max-w-[400px] text-sm leading-6 text-foreground/80">
                HireShelby lets you bring multiple agents into the same
                workspace. Your team will help you get started using HireShelby.
              </p>
