...
export const WELCOME_CANVAS_CONTENT = `# Welcome to HireShelby

This private channel is your home base for getting oriented. Shelby, Ada, and Miles can help you learn the app, troubleshoot setup, and work through something you are building.
...
Ask the team a question here, or read the [HireShelby user guide](https://github.com/hireshelby/hireshelby#readme).
`;
