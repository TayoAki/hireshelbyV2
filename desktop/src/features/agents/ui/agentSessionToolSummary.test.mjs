...
test("buildCompactToolSummary formats HireShelby send_message preview", () => {
...
test("buildCompactToolSummary derives structured actions for native HireShelby MCP tools", () => {
  const summary = buildCompactToolSummary(
    makeTool({
