...
// catalog entry has command="/Applications/HireShelby.app/.../buzz-agent" (resolved path).
...
test("editAgent_bugA_inheritedShortName_resolvesViaIdFallback", () => {
  ...
  const runtimes = [
    {
      id: "buzz-agent",
      command: "/Applications/HireShelby.app/Contents/MacOS/buzz-agent", // resolved path
...
test("editAgent_bugA_inheritedShortName_discoveryGatePasses", () => {
  ...
  const runtimes = [
    {
      id: "buzz-agent",
      command: "/Applications/HireShelby.app/Contents/MacOS/buzz-agent",
      availability: "available",
      defaultArgs: [],
    },
  ];
  ...
  assert.equal(
    ...
    "/Applications/HireShelby.app/Contents/MacOS/buzz-agent",
