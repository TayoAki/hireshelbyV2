 ...
 *
 * URL inputs (`https://`, `http://`, `hireshelby://join`) always carry a
 ...
 *  - `hireshelby://join?relay=<wsUrl>&code=<code>` → `{ relayWsUrl, code }`
