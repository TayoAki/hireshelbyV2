...
test("home page loads with HireShelby branding", async ({ page }) => {
  await page.goto("/");
  await expect(
    page.getByRole("main").getByRole("img", { name: "HireShelby" }),
  ).toBeVisible();
});
...
test("invite requires age and legal consent before opening HireShelby", async ({
  page,
}) => {
          ...
          assets: [
            {
              ...
              browser_download_url:
                "https://github.com/hireshelby/hireshelby/releases/download/v0.4.9/Buzz_0.4.9_aarch64.dmg",
            },
            {
              name: "Buzz_0.4.9_x64.dmg",
              browser_download_url:
                "https://github.com/hireshelby/hireshelby/releases/download/v0.4.9/Buzz_0.4.9_x64.dmg",
            },
            {
              name: "Buzz_0.4.9_amd64.AppImage",
              browser_download_url:
                "https://github.com/hireshelby/hireshelby/releases/download/v0.4.9/Buzz_0.4.9_amd64.AppImage",
            },
            {
              name: "Buzz_0.4.9_x64-setup_alpha-unsigned.exe",
              browser_download_url:
                "https://github.com/hireshelby/hireshelby/releases/download/v0.4.9/Buzz_0.4.9_x64-setup_alpha-unsigned.exe",
            },
          ],
        },
      ]),
  ...
  const acceptInvite = page.getByRole("button", {
    name: "Accept invite in HireShelby",
  });
  ...
  await page
    .locator("label")
    .filter({
      hasText: "I agree to the HireShelby Terms of Service and Privacy Policy.",
    })
