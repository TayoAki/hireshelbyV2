# HireShelby — Your Project, Your Domain
...
Next to it, a "Connect on HireShelby" button.
...
You hit "Connect on HireShelby" and the app opens. You're in `#general`. The team is
...
"Connect on HireShelby" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use HireShelby as a collaboration
layer on top of GitHub if that's what makes sense — work in HireShelby channels, push
...
Someone picks up the bug. They create a branch. HireShelby creates a channel:
...
things are announcements. Some things are essays. HireShelby has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on HireShelby"
