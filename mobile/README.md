...
Flutter mobile client for HireShelby.
...
`com.hireshelby.mobile.<slug>` on Android) plus a display-only branch label
in the app name (`HireShelby (my-branch)`, or a short SHA when the worktree is
