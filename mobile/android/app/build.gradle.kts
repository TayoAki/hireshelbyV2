...
android {
    namespace = "com.hireshelby.mobile"
    ...
    defaultConfig {
        applicationId = "com.hireshelby.mobile"
        ...
        resValue("string", "app_name", "HireShelby")
    }
    ...
    buildTypes {
        debug {
            ...
            if (worktreeLabel != null) {
                resValue("string", "app_name", "HireShelby ($worktreeLabel)")
            }
        }
        release {
            if (hasUploadSigning) {
