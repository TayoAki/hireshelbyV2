...
/// Name of the first-party HireShelby theme. HireShelby reuses the GitHub Light palette for
...
/// the two behave as a single "HireShelby" choice under System mode.
const buzzDarkThemeName = 'buzz-dark';

/// Whether [themeName] is either half of the HireShelby pair. Both halves enable the
...
/// The HireShelby gradient for the app's top section, or null when [themeName] is not
/// a HireShelby theme — in which case the section keeps its default frosted fill.
///
/// The stops are fully opaque: under HireShelby the color replaces the frosted
