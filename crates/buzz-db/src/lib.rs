#![deny(unsafe_code)]
#![warn(missing_docs)]
//! buzz-db — Postgres event store for HireShelby.
//!
//! ## Design invariants
...
pub mod partition;
/// HireShelby product-feedback sidecar persistence.
...
impl Db {
    ...
    /// ordering watermark. HireShelby mesh status coordinates also hard-delete their
