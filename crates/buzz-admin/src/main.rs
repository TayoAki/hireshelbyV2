...
//! HireShelby instance administration CLI.
//!
...
#[derive(Parser)]
#[command(name = "buzz-admin", about = "HireShelby instance administration")]
struct Cli {
    #[command(subcommand)]
    command: Command,
}
...
enum Command {
    ...
    Migrate,
    /// Inspect deployment-wide HireShelby product feedback.
    ProductFeedback {
        #[command(subcommand)]
