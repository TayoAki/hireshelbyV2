//! `buzz-test-cli` — Manual testing CLI for the HireShelby relay.
//!
//! # Usage
//!
//! ```text
...
//! Send a message:
//! ```text
//! buzz-test-cli --channel my-channel --send "Hello, HireShelby!"
//! ```
//!
...
fn print_help() {
    println!(
        r#"buzz-test-cli — Manual testing CLI for the HireShelby relay
