...
//! - HireShelby-agent personas emit BUZZ_AGENT_MODEL, BUZZ_AGENT_PROVIDER
...
"#,
    ...
    // HireShelby-agent persona
    fs::write(
        root.join("agents/buzz-bot.persona.md"),
        r#"---
name: "buzz-bot"
display_name: "HireShelby Bot"
...
"#,
    ...
    // HireShelby-agent persona gets BUZZ_AGENT_* env vars
