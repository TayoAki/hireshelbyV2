...
//!
//! Proves the security claim of HireShelby's membership-derived mesh admission:
...
//!      same builder calls HireShelby desktop makes with a resolved member roster.
...
//! corrupt each other — exactly how HireShelby runs it in production anyway (one
//! desktop = one node).
//!
