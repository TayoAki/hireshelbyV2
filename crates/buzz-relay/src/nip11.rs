...
impl RelayInfo {
    ...
    /// kinds 39000/39001/39002, which HireShelby signs with `state.relay_keypair`
    ...
    pub fn build(
        ...
        Self {
            name: "HireShelby Relay".to_string(),
            description: "HireShelby — private team communication relay".to_string(),
            ...
            push: None,
            software: "https://github.com/hireshelby/hireshelby".to_string(),
...
mod tests {
    ...
    fn build_advertises_buzz_repository_url() {
        ...
        assert_eq!(info.software, "https://github.com/hireshelby/hireshelby");
    }
