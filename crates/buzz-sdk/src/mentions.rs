//! `@name` and NIP-27 `nostr:npub1…` mention resolution helpers for HireShelby chat messages.
//!
...
///
/// Matches the cap enforced by HireShelby message builders and the legacy MCP
