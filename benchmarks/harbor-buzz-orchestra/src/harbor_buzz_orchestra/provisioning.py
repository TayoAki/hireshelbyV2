"""Typed boundary between the Harbor adapter and HireShelby trial provisioning."""
...
class AgentCredential:
    """One trial-scoped HireShelby identity and attributed LLM credential."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned HireShelby resources owned by one Harbor trial."""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated HireShelby resources synchronously."""
