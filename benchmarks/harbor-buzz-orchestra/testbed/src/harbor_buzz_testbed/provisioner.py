"""Channel-per-trial HireShelby provisioning against a local benchmark stack."""
...
class BuzzTrialProvisioner:
    """Implements the TrialHandle v1.1 contract against a live HireShelby relay.
    ...
    def _provision(
        ...
        # mirroring production HireShelby, where a human owns the channel their
        # agents work in.
